...
// Dark-mode aware: swaps square and glyph fills via prefers-color-scheme.
const LOGO = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 508 508" role="img" aria-label="Factory">
  <style>
    .bg { fill: #020202; }
    .mark { fill: #FAFAFA; }
